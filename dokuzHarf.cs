...
namespace KelimeOyunu
{
    class dokuzHarf
    {
        ...
        public void baglan()
        {
            ...
            MySqlCommand komut = new MySqlCommand("SELECT COUNT(*) FROM tbl_dokuzharf", baglanti);
            ...
            MySqlCommand cmd = new MySqlCommand("select * from tbl_dokuzharf where Id = '" + r + "'", baglanti);
