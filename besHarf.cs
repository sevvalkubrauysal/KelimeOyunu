...
namespace KelimeOyunu
{
    class besHarf
    {
        ...
        public void baglan()
        {
            ...
            MySqlCommand komut = new MySqlCommand("SELECT COUNT(*) FROM tbl_besharf", baglanti);
            ...
            MySqlCommand cmd = new MySqlCommand("select * from tbl_besharf where Id = '" + r + "'", baglanti);
