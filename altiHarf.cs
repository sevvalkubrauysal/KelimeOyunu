...
namespace KelimeOyunu
{
    class altiHarf
    {
        ...
        public void baglan()
        {
            ...
            MySqlCommand komut = new MySqlCommand("SELECT COUNT(*) FROM tbl_altiharf", baglanti);
            ...
            MySqlCommand cmd = new MySqlCommand("select * from tbl_altiharf where Id = '" + r + "'", baglanti);
