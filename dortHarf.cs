...
namespace KelimeOyunu
{
    class dortHarf
    {
        ...
        public void baglan()
        {
            ...
            MySqlCommand komut = new MySqlCommand("SELECT COUNT(*) FROM tbl_dortharf", baglanti);
            ...
            MySqlCommand cmd = new MySqlCommand("select * from tbl_dortharf where Id = '"+r+"'", baglanti);
