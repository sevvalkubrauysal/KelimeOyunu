...
namespace KelimeOyunu
{
    class yediHarf
    {
        ...
        public void baglan()
        {
            ...
            MySqlCommand komut = new MySqlCommand("SELECT COUNT(*) FROM tbl_yediharf", baglanti);
            ...
            MySqlCommand cmd = new MySqlCommand("select * from tbl_yediharf where Id = '" + r + "'", baglanti);
